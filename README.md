...
3.1. Abra o appsettings.json e configure a string de conexão no `appsettings.json` para acessar o banco de dados local. 
Deve ficar assim:
“Server=localhost;Database=em_hilberto_silva;Uid=root;Pwd={SUA_SENHA_AQUI};”.
3.2. Abra o Console do Gerenciador de Pacotes e execute o `Update-Database`.

3.3. Execute o projeto (F5).
